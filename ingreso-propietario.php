			 ...
			 if (document.form1.Cedula.value == "<?=$Cedula?>") 
			 {
				  ...
				  if (document.form1.Cedula.value) 
				  {
					  ...
					  if(document.form1.Cedula.value.length > 6)
						{ 
					   		ObtDatos("ajax_comprobar_cedula_propietario.php?q=" + document.form1.Cedula.value);
					    }
				  } 
			 }
		}
...
<a href="#" onClick="window.open('lista-propietarios-ing.php','','menubar=no,scrollbars=yes, width=500, height=500,');return false"><img src="Images/buscar.gif" width="16" height="16" border="0"></a></td>
          </tr>
        </table>

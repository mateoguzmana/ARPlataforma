...
{ 
   	window.opener.document.form1.Placa.value=cedula; 
...
<body>
<form name="form1" method="get" action="lista-placas.php">
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="retornavalores('<?=$Placa2?>')">

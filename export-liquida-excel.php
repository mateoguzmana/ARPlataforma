...
header("content-disposition: attachment;filename=reporte-liquidacion-$Codigo1.xls");
...
<HTML LANG="es">
<TITLE>::. Reporte Liquidacion Vales - Cod = <?=$Codigo1?> .::</TITLE>
</head>
<body>
...
<TR>
<TD align="left"><span style="font-size: 24px"><strong><?=$Empresa?> - NRO. CATAPORTE: <?=$Idca?></strong></span></TD>

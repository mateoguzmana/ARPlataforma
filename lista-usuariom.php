...
<script> 
function retornavalores(registro)
{ 
   
   window.opener.document.form1.Creamanif.value=registro; 
   window.close(); 
} 
</script>
...
<body>
<form name="forma" method="get" action="lista-usuariom.php">
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="retornavalores('<?=$Nombre?>')">

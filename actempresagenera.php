...
<body>
<form name="form1" method="GET" action="actempresagenera.php">
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="15%" bgcolor="#FFFFFF" class="textos"><a href="ingempresagenera.php?Id=<?=$Id8?>" target="genera"><img src="Images/update-ico-2.jpg" width="16" height="15" border="0"></a> | <a onclick=' return confirmSubmit()' href="eliempresagenera.php?Id=<?=$Id8?>"><img src="Images/delete-icon-2.jpg" width="16" height="15" border="0"></a></td>
          </tr>
        </table>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>

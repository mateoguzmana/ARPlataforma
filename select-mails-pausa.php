...
$querypr3			=	"SELECT COUNT(*) as Totalr3 FROM Remisiones where Manifiesto = '$Manifiestoev' and Remesa NOT LIKE '%-%'" ;
...
<form name="form2" id="form2" method="post" action="select-mails-pausa2.php" style="margin:0">
  <table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="1" class="listado11"><img src="Images/linea.jpg" width="100%" height="1"></td>
    </tr>
...
<table width="300" border="0" align="center" cellpadding="0" cellspacing="0" id="fila<?=$Idn?>">
  <tr>
    <td width="242" class="listado11"><?=$Nombrerem?><br>
...
{
?>      
<input name="no" type="button" class="TextField3" id="no" value="CONTINUAR" onClick="location.href='select-mails-pausa-no.php?Id=<?=$Idviaje?>&Idpuesto=<?=$Idpuesto?>&Pos=<?=$Pos?>'; alert('No se enviara ningun reporte'); return false">
<?
}
else
{
...
parent.location = 'pausartransito-empty.php?Id=<?=$Idviaje?>&Idpuesto=<?=$Idpuesto?>&Pos=<?=$Pos?>';

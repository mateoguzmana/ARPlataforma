  ...
  <tr>
    <td align="left" valign="top" bgcolor="#F7F7F7"><table width="100%" height="25" border="0" bordercolor="#FFFFFF" cellpadding="0" cellspacing="0" background="Images/bg-seleccion.jpg">
      <tr>
        ...
        <td width="98%" class="itemselect">AGENCIAS</td>
      </tr>
    </table>
      <table width="99%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#996633">
        <tr valign="middle" bordercolor="#FFFFFF" bgcolor="#E6E6E6">
          <td width="40%" valign="top" bordercolor="#F2F2F2" bgcolor="#F7F7F7"><iframe src="ingagencias.php" width="98%" height="100%" frameborder="No" allowtransparency="true"></iframe>
           
         </td>
          <td align="center" valign="top" bordercolor="#F2F2F2" bgcolor="#E6E6E6"><iframe src="actagencias.php" width="98%" height="100%" frameborder="No" allowtransparency="true"></iframe></td>
        </tr>
    </table></td>
  </tr>
</table>

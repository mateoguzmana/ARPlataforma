...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><iframe src="ing-propietario.php?dale=<?=$dale?>&Cedula=<?=$Id?>&Opc=<?=$Opc?>" width="100%" height="95%" frameborder="No" allowtransparency="true" name="propietario"></iframe></td>
  </tr>
</table>

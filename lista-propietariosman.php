...
<script> 
function retornavalores(cedula, nombre)
{ 
   window.opener.document.form1.Cedprop.value=cedula; 
   window.opener.document.form1.Propietario.value=nombre; 
   window.close(); 
} 
</script>
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="retornavalores('<?=$Cedula ?>', '<?=$Nombrer?>')">

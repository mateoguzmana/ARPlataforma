...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" bgcolor="#F7F7F7"><table width="100%" border="0" bordercolor="#FFFFFF" cellpadding="0" cellspacing="0" background="Images/bg-seleccion.jpg">
      <tr>
        <td width="2%" height="37" align="center" class="itemselect">&nbsp;</td>
        <td width="98%" class="itemselect">TIPO VEHICULOS</td>
        </tr>
    </table>
      ...
      <tr valign="middle" bordercolor="#FFFFFF">
        <td width="51%" height="243" valign="top" bordercolor="#F2F2F2" ><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="25" bgcolor="#F3F3F3" class="Estilo97">&nbsp; INGRESO <span class="Estilo105">TIPO DE VEHICULOS</span></td>
          </tr>
        </table>
          <iframe src="ingtipovehiculotemp.php" width="98%" height="98%" frameborder="No" allowtransparency="true"></iframe></td>
        <td width="49%" align="center" valign="top" bordercolor="#F2F2F2"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="25" class="Estilo97">&nbsp; ACTUALIZAR <span class="Estilo105">TIPO DE VEHICULOS</span></td>
          </tr>
        </table>          <iframe src="acttipovehiculotemp.php" width="99%" height="100%" frameborder="No" allowtransparency="true"></iframe></td>
        </tr>
    </table></td>
  </tr>
</table>

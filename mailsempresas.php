...
<table width="100%" border="0" bordercolor="#FFFFFF" cellpadding="0" cellspacing="0" background="Images/bg-seleccion.jpg">
      <tr>
        ...
        <td width="98%" class="itemselect">CONTACTO EMPRESAS</td>
      </tr>
</table>
<table width="100%" height="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#996633">
  <tr valign="middle" bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td width="50%" valign="top" bordercolor="#F2F2F2" bgcolor="#F7F7F7"><iframe src="ingmailsempresas.php" width="98%" height="100%" frameborder="No" allowtransparency="true"></iframe></td>
    <td width="50%" align="center" valign="top" bordercolor="#F2F2F2"><iframe src="actmailsempresas.php" width="98%" height="100%" frameborder="No" allowtransparency="true"></iframe></td>
  </tr>
</table>
</body>

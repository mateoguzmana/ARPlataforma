  ...
  <tr>
    <td align="left" valign="top" bgcolor="#F7F7F7"><table width="100%" height="20" border="0" bordercolor="#FFFFFF" cellpadding="0" cellspacing="0" background="Images/bg-seleccion.jpg">
      <tr>
        ...
        <td width="100%" align="left" class="itemselect1">INFORMACION DE PROPIETARIOS</td>
      </tr>

    </table>
<iframe src="propietarios-vehiculos.php?Id=<?=$Id?>&dale=<?=$dale?>&Opc=<?=$Opc?>" scrolling="no" width="100%" height="100%" frameborder="No" allowtransparency="true"></iframe></td>
  </tr>
</table>
</body>

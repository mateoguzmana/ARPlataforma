...
function retornavalores(registro, nombre){ 
   window.opener.document.form1.Idclase.value=registro; 
   window.opener.document.form1.Clase.value=nombre; 
   window.close(); 
} 
</script>
...
<body>
<form name="form1" method="get" action="lista-tipocarro.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="100" align="right" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="45%" height="35" bgcolor="#003366" class="listado2">&nbsp;<span class="listado1">&nbsp; </span>NOMBRE TIPO VEHICULO<br>
              <span class="listado3">
              &nbsp;
	...
	if ($Marca1 <> '')
	{
	$paging->agregarConsulta("SELECT* FROM Tipocarro where Nombre Like '%$Marca1%' order by Nombre Asc"); 
	}
	else
	{
	$paging->agregarConsulta("SELECT* FROM Tipocarro order by Nombre Asc"); 
	}

...
{ 
   window.opener.document.form1.Comercial.value=Comercial; 
   window.opener.document.form1.Cedcomer.value=Cedcomer; 
   window.close(); 
} 
</script>
...
<body>
<form name="form1" method="get" action="lista-usuarios.php">

...
<?
	$queryA		="SELECT COUNT(*) as Total FROM Controlbox where Leida = 1 and Finaliza = 1  and Asignado = 0 and Devol <> 1 and Fin = 0  " ;
...
<table width="580" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr onMouseover="this.bgColor='#BED9F3'"onMouseout="this.bgColor='#FFFFFF'" >
        ...
        <table width="580" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="80" align="center" valign="middle" bgcolor="#E9E9E9"><table width="570" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="341" height="30" align="left" valign="middle" bgcolor="#FFFFFF" class="Estilo97">&nbsp;&nbsp;ASIGNACION DE ENTREGA </td>
    ...
    <td height="21" class="Estilo93"><table width="565" border="0" cellpadding="0" cellspacing="0">
      <tr>
          <td width="410" height="29" bgcolor="#F4F4F4" class="Estilo97"><span style="font-size:14px">DISPONIBLES</span></td>
...
<table width="510" border="0" cellpadding="0" cellspacing="0" >
        <tr>
          <td height="15" class="listado11">&nbsp;<span class="accordion2" style="font-size:12px; font-weight:bold;">PEDIDOS SIN ASIGNAR</span></td>
...
<?
							$contq1e			=0;
							$querydOq1e			="SELECT* FROM Controlbox where Leida = 1 and Finaliza = 1  and Asignado = 0 and Devol <> 1 and Fin = 0 order By Id" ;
...
<?
							...
							$queryP		="SELECT COUNT(*) as Total FROM Controlbox where Leida = 1 and Finaliza = 1  and Asignado = 1 and Devol <> 1 and Fin = 0  and Nroasignacion = '$Nroasignacion' order By Id" ;
...
?>      
      ...
      <form name="form2" method="post" action="asignar-zona-ebel-bodega-paso.php" onSubmit = "return validar(this);">
        <br>
  <table width="560" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="410" height="29" bgcolor="#F4F4F4" class="Estilo97"><span style="font-size:14px">ASIGNADOS</span></td>
      <td width="60" align="right" bgcolor="#F4F4F4" class="listado11">&nbsp;</td>
    </tr>
  </table>
...
<table width="565" border="0" align="center">
  <tr>
    <td height="63" class="Estilo93"><div class="scroll">
      <table width="530" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="90" height="15" align="left" valign="middle" bgcolor="#E9E9E9" class="listado11">&nbsp;<span class="Estilo96">REMESA</span></td>
          <td width="309" align="left" valign="middle" bgcolor="#E9E9E9" class="listado11"><span class="Estilo96">NOMBRE</span></td>
          <td width="96" align="left" valign="middle" bgcolor="#E9E9E9" class="listado11"><span class="Estilo96">CATAPORTE</span></td>
          <td width="35" align="right" valign="middle" bgcolor="#E9E9E9">&nbsp;</td>
        </tr>
    </table>
      <br>
...
<?
							...
							$querydOq1o			="SELECT* FROM Controlbox where Leida = 1 and Finaliza = 1  and Asignado = 1 and Devol <> 1 and Fin = 0  and Nroasignacion = '$Nroasignacion' order By Id" ;
							$resultdOq1o		=mysql_query($querydOq1o, $id);
							
							While($rowdOq1o		=mysql_fetch_array($resultdOq1o))
							{
							$Idq1o				=$rowdOq1o["Id"];
							$Nombreq1o			=$rowdOq1o["Destinatario"];
							$Nropedido1o		=$rowdOq1o["Id"];
							$Cataporto			=$rowdOq1o["Cataporte"];
...
?>
      ...
      <table width="530" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="90" height="15" bgcolor="#DADADA" class="listado11"><?=$Idq1o?></td>
          <td width="309" align="left" bgcolor="#DADADA" class="listado11"><input name="textfield2" type="text" class="TextField2" id="textfield2" style="width:98%" value="<?=$Nombreq1o?>" readonly></td>
          <td width="96" align="left" bgcolor="#DADADA" class="listado11"><?=$Cataporto?></td>
          <td width="35" align="right" bgcolor="#DADADA">


<a onclick=' return confirmSubmit()' href="quitar-pedidos-salida-ebel.php?Nro=<?=$Idq1o?>">
<img src="Images/delete.png" width="12" hedddight="12" border="0">
</a>
...
?>
      ...
      <table width="557" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="205" height="22" bgcolor="#C9DACD" class="listado11">&nbsp;</td>
          <td width="85" bgcolor="#99CC00" class="listado11">&nbsp;TOTAL:
            <?=$TotalP?></td>
        </tr>
    </table></td>
  </tr>
    ...
    <table width="560" border="0">
      <tr>
        <td height="69" align="right"><p>
          <input name="button2" type="button" class="TextField32" id="button2" value="VOLVER" onclick="location.href='ingreso-sale-ebel-bodega-add.php?Borra=NO'">
        </p></td>
      </tr>
    </table></td>
  </tr>

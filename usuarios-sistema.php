...
<table width="100%"  height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="#F7F7F7"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" background="Images/bg-seleccion.jpg">
      <tr>
        <td width="1%" height="37" align="center" class="itemselect">&nbsp;</td>
        <td width="99%" class="itemselect">ZONA DE USUARIOS</td>
      </tr>
    </table>      <iframe src="usuarios.php" width="100%" height="95%" frameborder="No" allowtransparency="true"></iframe></td>
  </tr>
</table>
</body>

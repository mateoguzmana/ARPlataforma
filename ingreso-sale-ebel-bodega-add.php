          ...
          <tr>
            <td height="175" align="center" valign="middle" bgcolor="#E9E9E9"><br>
              ...
              <table width="540" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="39" bgcolor="#FFFFFF"><span class="listado11">CONDUCTOR</span><br>
                    <span class="Estilo1051"><?=$_SESSION['Nombre']?></span></tr>
              </table>
              <table width="540" border="0" cellpadding="0" cellspacing="0">
                <tr>
              ...
              <table width="540" border="0">
                ...
                <td width="265" height="59"><p>
                  <?
if(!empty($_SESSION['Nroasignacion']))
{
?>
                  <input name="button" type="button" class="TextField31" id="button" value="FINALIZAR ASIGNACION" onclick="location.href='fin-ingreso-sale-ebel-bodega.php?Borra=NO'">
...
?>
                ...
                <td width="265" align="right"><input name="button2" type="button" class="TextField32" id="button2" value="REVISAR MOVIMIENTOS" onclick="location.href='ingreso-sale-ebel-bodega-report.php?Borra=NO'"></td>
              </tr>
          </table></td>
          </tr>
        </table>

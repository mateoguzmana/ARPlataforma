...
<form name="form2" id="form2" method="post" action="select-mails-nota2.php" style="margin:0">
  <table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="1" class="listado11"><img src="Images/linea.jpg" width="100%" height="1"></td>
    </tr>
...
{
?>
<input name="no" type="button" class="TextField3" id="no" value="CONTINUAR" onClick="location.href='select-mails-nota2-no.php?Id=<?=$Idviaje?>'; alert('No se enviara ningun reporte'); return false">
<?
}
else
{

...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" valign="top"><iframe src="ingplanviaje.php?dale=<?=$dale?>" width="99%" height="95%" frameborder="No" allowtransparency="true" name="genera"></iframe></td>
    <td width="50%" valign="top"><iframe src="actplanesviaje.php" width="99%" height="95%" frameborder="No" allowtransparency="true"></iframe></td>
  </tr>
</table>

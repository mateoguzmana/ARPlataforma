...
?>
                                                ...
                                                <? if($TipoCuenta=="1") {?>       
												<form class="form-horizontal form-validate" role="form" method="post" action="act-cobros-3.php" id="form1" name="form1" novalidate>
                                                <? } 
                                                else if ($TipoCuenta=="2") {
                                                ?>  
                                                <form class="form-horizontal form-validate" role="form" method="post" action="act-cobros-4.php" id="form1" name="form1" novalidate>
                                                <? } ?>
												<div class="row">
														...
														<div class='input-group date' id='demo-date-start'>
															<input type="text" value="<?=$FechaInicio?>" class="form-control" required name="FechaPago" id="FechaPago" <?=$ponebloqueo?>/>
													...
													<div class="col-md-10">
													<input type="text" name="Valor" id="Valor" value="<?=$Valor?>" class="form-control dollar-mask" <?=$ponebloqueo?> required>
													...
													<div class="col-md-10">
													<select class="form-control" required name="Periocidad" id="Periocidad" <?=$ponebloqueo?>>
													...
													<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
														<div class='input-group date' id='demo-date-start'>
															<input type="text" value="<?=$FechaInicio?>" class="form-control" required name="FechaInicio" id="FechaInicio" <?=$ponebloqueo?>/>
															<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
																</div>
                                                                </div>
															</div>
														...
														<div class='input-group date' id='demo-date-end'>
															<input type="text" value="<?=$FechaFin?>" class="form-control" required name="FechaFin" id="FechaFin" <?=$ponebloqueo?>/>
															<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
														</div>
                                                                </div>
															</div>
														...
														<? } ?>
															...
															<div class="form-group">
																...
																<div class="col-lg-11 col-md-10 col-sm-9">
																	<br>
                                                                  <textarea name="Concepto" rows="3" required class="form-control" id="Concepto" <?=$ponebloqueo?>><?=$Concepto?></textarea>

...
?>
                                                ...
                                                <? if($TipoCuenta=="1") {?>       
												<form class="form-horizontal form-validate" role="form" method="post" action="act-pagos-3.php" id="form1" name="form1" novalidate>
                                                <? } 
                                                else if ($TipoCuenta=="2") {
                                                ?>  
                                                <form class="form-horizontal form-validate" role="form" method="post" action="act-pagos-4.php" id="form1" name="form1" novalidate>
                                                <? } ?>
												<div class="row">
													<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione un proveedor" style="background-color:#CCC" <?=$ponebloqueo?>>
            
                                                                        <?
                                                                        if(empty($Proveedor))
																		{
																		?>
                                                                  <option value="act-pagos-2.php?Id=<?=$IdPago?>&Opcion=<?=$TipoForm?>&IdProve=<?=$IdPre?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$NProveedor?></option>
                                                                        <?
																		}
																		else
																		{
																		...
																		$queryX		="SELECT * FROM Proveedores WHERE (Id <> '$Proveedor' || Id <> '$IdProve')  order by Nombre";
                                                                        ...
                                                                        ?>
                                                                        <option value="act-pagos-2.php?Id=<?=$IdPago?>&Opcion=<?=$TipoForm?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$Nombreproveedor?></option>
																		<?
																		}
																		?>
                                                                </select>
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione una Obra" style="background-color:#CCC" <?=$ponebloqueo?>>
            															<?
                                                                        if(empty($Proveedor))
																		{
																		?>
                                                                  <option value="act-pagos-2.php?Id=<?=$IdPago?>&Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Obra?></option>
																		...
																		$queryFOX 		="SELECT * FROM Obrasprov WHERE  Proveedor='$ese' ";
																		$resultFOX		=mysql_query($queryFOX,$id);

																		while ($rowFOX=mysql_fetch_array($resultFOX)) {
																		$ObraX 			=$rowFOX["Idobra"];

																		$queryTIP		="SELECT * FROM Obras where Muestra = 0 and Id <> '$Idobra' and Id='$ObraX' order by Nombre";
                                                                        ...
                                                                        ?>
                                                                        <option value="act-pagos-2.php?Id=<?=$IdPago?>&IdProve=<?=$Alter?>&Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		}
																		?>
												...
												<div class="col-sm-12">
														...
														<div class='input-group date' id='demo-date-start'>
															<input type="text" <?=$ponebloqueo?> value="<?=$FechaInicio?>" class="form-control" required name="FechaPago" id="FechaPago"/>
															<?if($Estado!=2){?><span class="input-group-addon"><i class="fa fa-calendar"></i></span><?}?>
														</div>
                                                                </div>
															</div>
														</div>
														...
														<div class='input-group date' id='demo-date-end'>
															<input type="text" <?=$ponebloqueo?> value="<?=$FechaFin?>" class="form-control" required name="FechaFin" id="FechaFin" />
															<?if($Estado!=2){?><span class="input-group-addon"><i class="fa fa-calendar"></i></span><?}?>
														</div>
                                                                </div>
															</div>
													...
													<div class="col-md-10">
													<input type="text" name="NumeroFactura" <?=$ponebloqueo?> id="NumeroFactura" class="form-control" value="<?=$NumeroFactura?>" required>
													...
													<div class="col-md-10">
													<input type="text" name="Valor" <?=$ponebloqueo?> id="Valor" value="<?=$Valor?>" class="form-control dollar-mask" required>
														...
														<div class="col-sm-12">
															...
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	...
																	<select name="Retencion" id="Retencion" class="form-control select2-list" data-placeholder="Seleccione el tipo de cuenta" required <?=$ponebloqueo?>>
            
                                                                        <option value="<?=$Retencion?>" selected><?=$NombreRT?></option>
													...
													<div class="col-md-10">
													<select class="form-control" <?=$ponebloqueo?> required name="Periocidad" id="Periocidad">
													...
													<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
														<div class='input-group date' id='demo-date-start'>
															<input type="text" <?=$ponebloqueo?> value="<?=$FechaInicio?>" class="form-control" required name="FechaInicio" id="FechaInicio"/>
												...
												<div class="col-sm-12">
															<div class="form-group">
																...
																<div class="col-lg-11 col-md-10 col-sm-9">
																	<br>
                                                                  <textarea name="Concepto" <?=$ponebloqueo?> rows="3" required class="form-control" id="Concepto" onChange="javascript:this.value=this.value.toUpperCase();"><?=$Concepto?></textarea>
																<input name="TipoCuenta" id="TipoCuenta" type="hidden" value="<?=$TipoCuenta?>">																
																<input name="Id" id="Id" type="hidden" value="<?=$IdPago?>">
																<input name="Estado" id="Estado" type="hidden" value="<?=$Estado?>">
																</div>
															</div>
														</div>
...
FECHA ANULACIÓN: <?=$FechaAnulacion?>&nbsp;&nbsp;|&nbsp;&nbsp;USUARIO: <?=$NombreUsuario?></textarea>
													...
													<div class="form-group">
														...
														<div class="col-lg-11 col-md-10 col-sm-9">
															...
															<?}?>
															<input name="Volver" type="button" class="btn btn-warning" value="Volver"  onClick="location.href='act-pagos.php?Idmenu=7&Idsubmenu=14&Idopcmenu=20'">
														</div>
													</div>

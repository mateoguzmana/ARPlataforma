...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-pagar-recu-2.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
												...
												<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <?if (!empty($TipoForm)) { ?>
                                                                <option value="add-pagar-recu.php?Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Opcion?></option>
                                                                <? } 
                                                                else { ?>
                                                                ...
                                                                ?>
                                                                <option value="add-pagar-recu.php?Idobra=<?=$Idobra?>&Opcion=1&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>">SI</option>
                                                                <option value="add-pagar-recu.php?Idobra=<?=$Idobra?>&Opcion=2&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>">NO</option>
                                                                </select>
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione una Obra" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-pagar-recu.php?Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreobra?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-pagar-recu.php" selected>Seleccione una Obra</option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="add-pagar-recu.php?Idobra=<?=$IdTIP?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		?>
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione un proveedor" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-pagar-recu.php?Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$NombreProve?></option>
                                                                        <?
																		}
																		else
																		{
                                                                        ...
                                                                        ?>
                                                                        <option value="add-pagar-recu.php?Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$Nombreproveedor?></option>
																		<?
																		}
																		}
																		}else{

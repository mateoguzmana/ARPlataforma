...
$sql="INSERT INTO  CuentasPagar (TipoCuenta,Opcion,Idobra,Idproveedor,Obra,Proveedor,FechaInicio,FechaFin,Periocidad,Valor,Concepto,Usuario,Estado)";
$sql.= "VALUES ('$TipoCuenta' , '$Opcion' , '$Idobra' , '$Idproveedor' , '$Obra' , '$Proveedor' , '$FechaInicio' , '$FechaFin' , '$Periocidad' ,'$Valor' , '$Concepto','$Usuario','0')";
mysql_query($sql);

						...
						<div class="row">
							<div class="col-lg-12">
								<div class="box">
									<div class="box-body table-responsive">
										<table id="datatable0" class="table table-striped table-hover">
											<thead>
												<tr>
													<th>Nombre</th>
													<th>Unidad</th>
							...
							$MosPerzB			=$rowPerz1["Del"];
								...
								$MosPerz2	=	1;
                                                ...
                                                $queryUSERS			="SELECT* FROM Descripcion where Muestra = 0";
												...
												<tr class="gradeA">
													<td><?=$NombreUSERS?></td>
													<td><?=$NombreTIP?></td>
													<td>$ <?=number_format($ValorUnidad,0,'','.')?></td>
													<td class="text-right">
														...
														{
														?>                                                    
													<input name="Procesar" type="button" class="btn btn-primary" value="MODIFICAR"  onClick="location.href='act-descripcion2.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        <?
														}
														?> 
														...
														{
														?>  
													<input name="Eliminar" type="button" class="btn btn-danger" value=" ELIMINAR " data-toggle="modal" data-target="#textModal<?=$Id?>" data-placement="top">
                                                        <?
														}
														?> 
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-success" onclick="location.href='eli-descripcion.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'">Confirmar</button>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div><!-- /.modal-dialog -->
                                                </div><!-- /.modal -->

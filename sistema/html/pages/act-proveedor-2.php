...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$IdUS				=$_REQUEST['Id']; 
					 ...
					 $queryUSERS		="SELECT* FROM Proveedores where Id = '$IdUS'";
					 ...
					 While($rowUSERS	=mysql_fetch_array($resultUSERS))
					 {
						...
						$NumeroCuenta		=$rowUSERS["NumeroCuenta"];
						$Titular			=$rowUSERS["Titular"];
						$Identificacion		=$rowUSERS["Identificacion"];
						$FormaPago			=$rowUSERS["FormaPago"];
						$Banco 				=$rowUSERS["Banco"];
					 }
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												...
												<form class="form-horizontal form-validate" role="form" method="post" action="act-proveedor-3.php" novalidate>
													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Razón Social/Nombre" value="<?=$Nombre?>" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Ciudad" id="Ciudad" class="form-control" placeholder="Ciudad" value="<?=$Ciudad?>" onChange="javascript:this.value=this.value.toUpperCase();" required>
																</div>
															</div>
														</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Direccion" id="Direccion" class="form-control" placeholder="Dirección" value="<?=$Direccion?>" onChange="javascript:this.value=this.value.toUpperCase();" required>
																</div>
															</div>
														</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Telefono" id="Telefono" class="form-control" placeholder="Teléfono" value="<?=$Telefono?>" onKeyPress="return isNumberKey(event);" required>
																</div>
															</div>
														</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Celular" id="Celular" class="form-control" placeholder="Celular"  value="<?=$Celular?>" onKeyPress="return isNumberKey(event);" required>
																</div>
															</div>
														</div>
                                                        ...
                                                        <div class="col-sm-6">
															<div class="form-group">
																...
																<select name="TipoCuenta" id="TipoCuenta" class="form-control select2-list" data-placeholder="Seleccione el tipo de cuenta" required>
                                                                        ...
                                                                        <option value="<?=$TipoCuenta?>" selected><?=$TipoCuenta?></option>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="NumeroCuenta" id="NumeroCuenta" class="form-control" value="<?=$NumeroCuenta?>" placeholder="Numero de cuenta" required>
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Titular" id="Titular" class="form-control" value="<?=$Titular?>" placeholder="Titular de la cuenta" required>
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Identificacion" id="Identificacion" value="<?=$Identificacion?>" class="form-control" placeholder="Cedula" required>
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<select name="FormaPago" id="FormaPago" class="form-control select2-list" data-placeholder="Seleccione la forma de Pago" required>
                                                                        ...
                                                                        <option value="<?=$FormaPago?>" selected><?=$FormaPago?></option>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="password" name="Contrasena" id="Contrasena" class="form-control" placeholder="Contraseña" value="<?=$password?>" required data-rule-minlength="6">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="password" name="Contrasena1" id="Contrasena1" class="form-control" placeholder="Repita la Contraseña" value="<?=$password?>" required  data-rule-equalto="#Contrasena" data-rule-minlength="6">
																</div>
															</div>
														</div>

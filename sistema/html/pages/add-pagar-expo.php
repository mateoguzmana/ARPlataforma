                                                ...
                                                <div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione un proveedor" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-pagar-expo.php?Opcion=<?=$TipoForm?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$NombreProve?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-pagar-expo.php" selected>Seleccione un proveedor</option>
                                                                        <?
																		}
																		if ($TipoForm=="1") {
                                                                        ...
                                                                        ?>
                                                                        <option value="add-pagar-expo.php?Opcion=<?=$TipoForm?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$Nombreproveedor?></option>
																		<?
																		}
																		}
																		}else{
													...
													<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione una Obra" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-pagar-expo.php?Idobra=<?=$Idobra?>&IdProve=<?=$Idproveedor?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreobra?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-pagar-expo.php" selected>Seleccione una Obra</option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="add-pagar-expo.php?Idobra=<?=$IdTIP?>&IdProve=<?=$Proveedor?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		}
																		?>
...
?>
													...
													<div class="col-md-10">
													<input type="text" name="NumeroFactura" id="NumeroFactura" onkeypress="isNumberKey()" class="form-control" required>

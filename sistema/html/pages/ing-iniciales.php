...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-iniciales-2.php" novalidate>
                                                        <?
														}
														else
														{
												...
												<form class="form-horizontal form-validate" role="form" method="post"  novalidate>
													...
													<div class="row">
														<div class="col-sm-6">
															<div class="form-group">
																...
																<select name="Empresa" id="Empresa" class="form-control select2-list" required>
																		...
																		<?
                                                                        $queryXD		="SELECT* FROM Clientes order by Nombre";
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Nombre" class="control-label">Inicial</label>
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Iniciales" value="" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
													</div>

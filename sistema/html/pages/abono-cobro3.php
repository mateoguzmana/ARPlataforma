...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$queryJAJA 		="SELECT * FROM HistorialCobros WHERE Id='$Id'";
					...
					$querySIN		="SELECT * FROM CuentasCobrar WHERE Id = '$IdPago'";
...
?>
												...
												<form class="form-horizontal form-validate" role="form" method="post" action="cobrar-3.php?Id=<?=$IdPago?>" id="form1" name="form1" novalidate>
												...
												<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" disabled class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione una Obra" style="background-color:#CCC" <?=$ponebloqueo?>>
            															<?
                                                                        if(empty($Idobra))
																		{
																		?>
                                                                  <option value="act-cobros-2.php?Id=<?=$IdPago?>&Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Obra?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="act-cobros-2.php" selected><?=$Nombreobra?></option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="act-cobros-2.php?Id=<?=$IdPago?>&Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		?>
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" disabled class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione un proveedor" style="background-color:#CCC" <?=$ponebloqueo?>>
																		...
																		{
																		?>
                                                                  <option value="act-cobros-2.php?Id=<?=$IdPago?>&Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&IdProve=<?=$IdPre?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$NProveedor?></option>
                                                                        <?
																		}
																		else
																		{
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-lg-2 col-md-4 col-sm-6">
																	<label for="Inicio" class="control-label">Fecha cobro</label>
																</div>
                                                                
                                                                <div class="col-md-10">
                                                                
														<div class='input-group date' id='demo-date-start'>
															<input type="text" value="<?=$FechaAbono?>" disabled class="form-control" required name="FechaPago" id="FechaPago" <?=$ponebloqueo?>/>
													...
													<div class="col-sm-6">
														...
														<? } ?>
															...
															<div class="form-group">
																...
																<div class="col-lg-11 col-md-10 col-sm-9">
																	<br>
                                                                  <textarea name="Concepto" rows="3" disabled required class="form-control" id="Concepto" <?=$ponebloqueo?>><?=$Concepto?></textarea>
														...
														<div class="col-sm-6">
															...
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                <select name="CuentaContable" id="jumpMenu" disabled class="form-control" required style="background-color:#CCC" <?=$ponebloqueo?>>
														...
														<div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
																...
																<div class="col-md-10">
																<input type="text" name="Abono" id="Abono" value="<?=$Abono?>" disabled class="form-control dollar-mask" required>
													...
													<div class="form-group">
														...
														<div class="col-lg-11 col-md-10 col-sm-9">
															<br/><br/>
															<?if($Estado==4){?>
															<input name="Imprimir" type="button" class="btn btn-warning" value="Imprimir"  style="width:100px;" onClick="window.open('print-abonocobro.php?Id=<?=$IdPago?>&Idcliente=<?=$IdclienteUSERS?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>','_blank')">
															<!--<button type="submit" id="enviar" class="btn btn-primary">Realizar Cobro</button>-->
															<? } 
															elseif ($Estado==1) { ?>

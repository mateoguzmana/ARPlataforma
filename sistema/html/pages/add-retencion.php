...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-retencion-2.php" novalidate>
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Nombre del tipo de retención" value="" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-lg-2 col-md-4 col-sm-6">
																	<label for="Apellidos" class="control-label">Valor</label></div>
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Valor" id="Valor" class="form-control" placeholder="Porcentaje de la retención %">
																</div>
															</div>
														</div>
													</div>

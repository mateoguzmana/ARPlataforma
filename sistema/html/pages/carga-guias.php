								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Carga de guías</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" enctype="multipart/form-data" method="post" action="cargaguiascsv.php?Idsubmenu=<?=$_REQUEST["Idsubmenu"]?>&Idmenu=<?=$_REQUEST["Idmenu"]?>&Idopcmenu=<?=$_REQUEST["Idopcmenu"]?>" novalidate>
                                                        <?
														}
														else
														{
                                            ...
                                            <div class="well">
                                            <span class="label label-warning"><i class="fa fa-upload"></i></span>
                                            <span><strong>Estructura del archivo.</strong></span><br></br>
											<span>GUIA - DESCRIPCION - PESO - PIEZAS | DESTINATARIO - DIR. DESTINATARIO - CIUDAD - DEPARTAMENTO - VLR DECLARADO - TELEFONO | REMITENTE - DIR. REMITENTE - CIUDAD - TELEFONO</span>
											</div>
													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																<label for="Archivo" class="control-label">Archivo excel</label>
																<input type="file" name="filex" id="Archivo" class="form-control"  placeholder="Archivo" required>
																</div>
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														{
														?>
															<button type="button" onclick="cargar(this.form);" class="btn btn-primary">Realizar Operación</button>
                                                        <?
														}
														?> 
														</div>
...
var empresa1 	=	document.getElementById('Empresa');
...
var extension1 	= 	(archivo1.substring(archivo1.lastIndexOf("."))).toLowerCase();
	...
	if (empresa=="") 
  { alert("Ingresa una empresa"); empresa1.focus(); return; }
  
  if (archivo=="") 
  { alert("Seleccione un archivo"); archivo.focus(); return; }

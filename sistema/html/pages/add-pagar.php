...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-pagar-2.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                              	...
                                                              	<input name="Nombre" id="Nombre" type="hidden" value="<?=$Nombreobra?>">
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione una Obra" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-pagar.php?Idobra=<?=$Idobra?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreobra?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-pagar.php" selected>Seleccione una Obra</option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="add-pagar.php?Idobra=<?=$IdTIP?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		?>
    ...
    <div class="added">
                                <table width="100%" border="0" style="font-size:11px; border-color:#E4E4E4" cellpadding="0" cellspacing="0">
                                  <tr>
                                    ...
                                    <td width="15%"><input type="text" name="plano1" id="plano1" placeholder="Obra" style="width:99%; font-size:11px;" onChange="javascript:this.value=this.value.toUpperCase();" onClick="window.open('lista-obras.php?Idcliente=<?=$Idcliente?>&Cont=1','precios','menubar=no,scrollbars=yes, width=600, height=600');return false" readonly/>
                                    <input name="Idobra1" type="hidden" id="Idobra1"></td>

...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					if(empty($_SESSION["CuentaContable2"])){
					$CuentaContable 	=$CuentaContable;
					}
					else{
					$CuentaContable=$_SESSION["CuentaContable2"];
					}
					
					if(empty($_SESSION["Observaciones2"])){
					$Observaciones 		=$Observaciones;	
					}
					else{
					$Observaciones 		=$_SESSION["Observaciones2"];	
					}
					...
					*/
					...
					$queryTITMEN		="SELECT* FROM Obras WHERE Idcliente = '$Idcliente'" ;
					$resultTITMEN		=mysql_query($queryTITMEN, $id);
													...
													<input type="text" name="Valor" id="Valor" disabled value="<?=$Valor?>" class="form-control dollar-mask" <?=$ponebloqueo?> required>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                <select name="Obra" class="form-control" required  data-placeholder="Seleccione una Obra" style="background-color:#CCC">
            															<?	
                                                                        ...
                                                                        $queryTIP		="SELECT* FROM Obras where Muestra = 0 AND Id='$Obris' order by Nombre";
													...
													<div class="col-sm-6">
														...
														<div class="col-sm-6">
															...
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                <select name="CuentaContable" id="jumpMenu" class="form-control" required style="background-color:#CCC" <?=$ponebloqueo?>>
													...
													<div class="col-sm-6">
														...
														<div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
																...
																Abono=Abono.replace("$","");
																Descuento=((Abono*Retencion));
																Desc=(Abono-Descuento);
																Descuento=format1(Descuento);
																Desc=format1(Desc);
																//Desc=accounting.formatNumber(Desc);
																document.getElementById('resp').innerHTML='<span style="padding:5px;" class="alert-success">Descuento de $ '+Descuento+' √</span>';
																document.getElementById('real').innerHTML='<span style="padding:5px;" class="alert-success">Pagas $&nbsp;<input class="alert-success" id="ValorReal" type="text" readonly name="ValorReal" value="'+Desc+'"> √</span>';
																}
																</script>
														</div>
														</div>
...
?>
                                <table width="100%" class="btn-default" style="font-size:10px; height:20px; border: 1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC;  <?=$stilos?> " >
                                  <tr>
                                    ...
                                    <td width="35%" style="font-size:10px; height:20px; border: 1px solid #CCC; border-left:1px solid #CCC; border-right:1px solid #CCC;  <?=$stilos?> ">&nbsp;<?=$Obser?></td>                                  

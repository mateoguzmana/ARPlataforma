...
$sql="UPDATE Actasobra set Idproveedor='$Idproveedor',Idobra='$Obra',Fechafact='$Fechafact', 
Contrato='$Contrato', Descripcion='$Descripcion', Fecha='$horaactual', Usuario='$Usuario' WHERE Id='$Id'";
mysql_query($sql);

$query33 	="DELETE FROM Movacta WHERE Idacta='$Id'";

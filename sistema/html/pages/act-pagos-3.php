...
Obra='$Obra',Proveedor='$Proveedor' ,FechaInicio='$FechaInicio', FechaFin='$FechaFin' , Retencion='$Retencion' ,Valor='$Valor', ValorRetencion='$ValorRetencion' ,Concepto='$Concepto',Estado='$Estado' WHERE Id='$Id'  ";

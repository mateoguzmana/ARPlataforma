...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-cobrar-expo-2.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione un proveedor" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-cobrar-expo.php?Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$NombreProve?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-cobrar-expo.php" selected>Seleccione un Cliente</option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="add-cobrar-expo.php?Idobra=<?=$Idobra?>&Opcion=<?=$TipoForm?>&IdProve=<?=$Idproveedor?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$Nombreproveedor?></option>
																		<?
																		}
																		?>
													...
													<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione una Obra" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-cobrar-expo.php?Idobra=<?=$Idobra?>&IdProve=<?=$Idproveedor?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreobra?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-cobrar-expo.php" selected>Seleccione una Obra</option>
                                                                        <?
																		}
																		
                                                                        $queryTIP		="SELECT* FROM Obras where Muestra = 0 and  Idcliente='$Proveedor' order by Nombre";
                                                                        ...
                                                                        ?>
                                                                        <option value="add-cobrar-expo.php?Idobra=<?=$IdTIP?>&IdProve=<?=$Proveedor?>&Opcion=<?=$TipoForm?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		?>
...
?>
												...
												<div class="col-sm-6">
													...
													<div class="col-md-10">
													<input type="text" name="NumeroFactura" id="NumeroFactura" class="form-control dollar-mask" required>

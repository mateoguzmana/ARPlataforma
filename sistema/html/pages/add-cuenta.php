...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-cuenta-2.php" novalidate>
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Nombre de la cuenta" value="" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Cedula" id="Cedula" class="form-control" placeholder="Nro. de Cuenta" value="" onKeyPress="return isNumberKey(event);" required data-rule-minlength="4">
																</div>
															</div>
														</div>
													</div>

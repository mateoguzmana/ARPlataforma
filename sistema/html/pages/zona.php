			...
			<div id="content">
				<section>
					<div class="section-header">
						<h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> Inicio</h3>
					</div>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="box box-bordered style-primary">
									...
									<div class="box-body">
										<p style="font-size:17px;">Restan <strong><?=$diferencia1?></strong> días para vencerse la cuenta.</p>
							...
							<div class="col-lg-6">
								<div class="box box-bordered style-primary-gradient">
									...
									<div class="box-body">
										<p style="font-size:17px;">Restan <strong><?=$diferencia?></strong> días para vencerse la cuenta.</p>
										<table style="font-size:15px;">
											<tr>
												<td><?=$Id?> |</td>
												<td><?=$Proveedor?> |</td>

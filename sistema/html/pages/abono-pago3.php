...
?>
												...
												<form class="form-horizontal form-validate" role="form" method="post" action="pagar-3.php?=Id=<?$IdPago?>" id="form1" name="form1" novalidate>
                                                        ...
                                                        <div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
															<input type="text" disabled <?=$ponebloqueo?> value="<?=$FechaAbono?>" class="form-control" required name="FechaPago" id="FechaPago"/>
													...
													<div class="col-md-10">
													<input type="text" name="Valor" disabled <?=$ponebloqueo?> id="Valor" value="<?=$Valor?>" class="form-control dollar-mask" required>
												...
												<div class="col-sm-12">
                                                     ...
                                                     <div class="col-sm-6">
                                                     	<br>
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                <select name="CuentaContable" id="jumpMenu" disabled class="form-control" required <?=$ponebloqueo?>>
														...
														<div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
																...
																<div class="col-md-10">
																<input type="text" name="Abono" id="Abono" disabled value="<?=$Abono?>" class="form-control dollar-mask" required>
														...
														<div class="col-sm-12">
															<div class="form-group">
																...
																<div class="col-lg-11 col-md-10 col-sm-9">
																	<br>
                                                                  <textarea name="Observaciones" <?=$ponebloqueo?> rows="3" disabled required class="form-control" onChange="javascript:this.value=this.value.toUpperCase();" id="Observaciones"><?=$Observaciones?></textarea>
																</div>
															</div>
														</div>
                                                     </div>   
													...
													<div class="form-group">
														...
														<div class="col-lg-11 col-md-10 col-sm-9">
															...
															<input name="Imprimir" type="button" class="btn btn-warning" value="Imprimir"  style="width:100px;" onClick="window.open('print-abonopago.php?Id=<?=$IdPago?>&Idpago=<?=$Id?>&Idcliente=<?=$IdclienteUSERS?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>','_blank')">
															<!--<button type="submit" id="enviar" class="btn btn-primary">Realizar Pago</button>-->
															<? } 
															elseif ($Estado==1) { ?>
															<input name="Imprimir" type="button" class="btn btn-warning" value="Imprimir"  style="width:100px;" onClick="window.open('print-pagos.php?Id=<?=$IdPago?>&Idpago=<?=$Id?>&Idcliente=<?=$IdclienteUSERS?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>','_blank')">
															<?
															}
															?>
															<input name="Volver" type="button" class="btn btn-info" value="Volver"  onClick="location.href='abono-pago.php?Idmenu=7&Idsubmenu=14&Idopcmenu=40'">
														</div>
													</div>

...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$IdUS				=$_REQUEST['Id']; 
					 ...
					 $queryUSERS		="SELECT* FROM Clientes where Id = '$IdUS'";
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												...
												<form class="form-horizontal form-validate" role="form" method="post" action="act-cliente-3.php" novalidate>
													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Especial" class="control-label">Especial</label>
																<select name="Especial" id="Especial" class="form-control select2-list" required>
                                                                        <option value="<?=$Especial?>" selected><?=$Opcion?></option>
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="password" name="Contrasena" id="Contrasena" class="form-control" placeholder="Contraseña" value="<?=$Contrasena?>" required data-rule-minlength="6">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-sm-12">
																	...
																	<input type="password" name="Contrasena1" id="Contrasena1" class="form-control" placeholder="Repita la Contraseña" value="<?=$Contrasena?>" required  data-rule-equalto="#Contrasena" data-rule-minlength="6">
																</div>
															</div>
														</div>

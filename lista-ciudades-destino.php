...
<script> 
function retornavalores(registro, Codorg){ 
   window.opener.document.form1.Destino.value=registro;
   window.opener.document.form1.Coddest.value=Codorg;
...
<body>
<form name="forma" method="get" action="lista-ciudades-destino.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="100" align="right" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="45%" height="35" bgcolor="#003366" class="listado2">&nbsp;<span class="listado1">&nbsp; </span>NOMBRE CIUDAD <br>
              <span class="listado3">
              &nbsp;
	...
	if ($Marca1 <> '')
	{
	$paging->agregarConsulta("SELECT* FROM Municipio where Nombre Like '%$Marca1%' order by Nombre Asc"); 
	}
	else
	{
	$paging->agregarConsulta("SELECT* FROM Municipio order by Nombre Asc"); 
	}
...
{	
$Nombre			=strtoupper($row008["Nombre"]);
$Cod			=$row008["Cod"];
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0"  onClick="retornavalores('<?=$Nombre?>', '<?=$Cod?>')">
            ...
            <tr name="datos1" id="datos1" onMouseover="this.bgColor='#BED9F3'"onMouseout="this.bgColor='#FBFBFB'" >
              <td height="15"><span class="Estilo93"><?=strtoupper($Nombre)?></span></td>
            </tr>

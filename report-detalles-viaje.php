...
<table width="99%" height="5%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" align="right"><span class="Estilo93"><a href="<?=$_SESSION['anterior-reportviaj'];?>" >VOLVER</a></span>
    <hr></td>
  </tr>
</table>
<table width="100%" height="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="73%" valign="top"><table width="96%" height="5%" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="98%" border="0" cellpadding="0" cellspacing="0" height="40%">
        <tr>
      ...
      <table width="98%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td>
          <iframe src="accionesviaje-end.php?Id=<?=$Id?>" width="100%" height="50px" frameborder="No" allowtransparency="true"></iframe>
          </td>
        </tr>
      </table>

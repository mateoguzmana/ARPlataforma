...
function retornavalores(registro, nombre){ 
   window.opener.document.form1.Configtrailer.value=registro; 
   window.opener.document.form1.Configtrailer.value=nombre; 
   window.close(); 
} 
</script>
...
<form name="form1" method="get" action="lista-lineas.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	$paging->agregarConsulta("SELECT* FROM Configremol order by Nombre Asc"); 
...
?>
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="retornavalores('<?=$Nombre ?>', '<?=$Nombre?>')">
            <tr name="datos1" id="datos1" onMouseover="this.bgColor='#BED9F3'"onMouseout="this.bgColor='#F0F0F0'" >
              <td width="15%" height="77"><span class="Estilo97"><?=strtoupper($Nombre)?></span></td>
              <td width="85%"><img src="configuracion/<?=$Foto?>"></td>
            </tr>
        </table>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>

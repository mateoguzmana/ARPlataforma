...
<table width="570" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="20" align="right" valign="middle" class="Estilo97"><a href="content.html" onClick="lbIframeClose();"><img src="Images/close-icon.png" width="20" height="20" border="0"></a></td>
      ...
      <table width="570" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" align="center" valign="middle" bgcolor="#E9E9E9" class="Estilo97">FINALIZACION  DE &nbsp;PEDIDO</td>
        </tr>
    </table>
      <br>
      <form name="form1" method="post" action="ingreso-fin-bodega-2.php">
        <table width="570" border="0" cellpadding="0" cellspacing="0">
          <tr>

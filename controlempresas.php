...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="70%" valign="top"><iframe src="ingempresagenera.php?dale=<?=$dale?>" width="99%" height="95%" frameborder="No" allowtransparency="true" name="genera"></iframe></td>
    <td width="30%" valign="top"><iframe src="actempresagenera.php" width="99%" height="95%" frameborder="No" allowtransparency="true"></iframe></td>
  </tr>
</table>

...
{ 
   window.opener.document.form1.Calidad.value=Comercial; 
   window.opener.document.form1.Cedcalidad.value=Cedcomer; 
   window.close(); 
} 
</script>
...
<body>
<form name="form1" method="get" action="lista-calidad.php">

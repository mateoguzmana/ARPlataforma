...
$query000			="SELECT* FROM Manifiestos where Id = '$Id' " ;
$result000			=mysql_query($query000, $id);
		
While($row000		=mysql_fetch_array($result000))
{
$Agencia			=$row000["Sucursal"];
$Manifiesto			=$row000["Nromanifiesto"];
$Fecha				=$row000["Fecha"];
$Propietario		=$row000["Propietario"];
$Conductor			=$row000["Conductor"];
$Placa				=$row000["Placa"];
$Empresa			=$row000["Empresa"];
$Origen				=$row000["Origen"];
$Nombreorg			=$row000["Nombreorg"];
$Destino			=$row000["Destino"];
$Nomdest			=$row000["Nomdest"];
$Fechacrea			=$row000["Fechacrea"];

	$query001			="SELECT* FROM Propietarios where Cedula = '$Propietario' " ;
	$result001			=mysql_query($query001, $id);
			
	While($row001		=mysql_fetch_array($result001))
	{
	$NombrefullP		=$row001["Nombrefull"];
	}
	
	$query002			="SELECT* FROM Conductores where Cedula = '$Conductor' " ;
	$result002			=mysql_query($query002, $id);
			
	While($row002		=mysql_fetch_array($result002))
	{
	$NombrefullC		=$row002["Nombrefull"];
	}
	
	
	$query003			="SELECT* FROM Empresas where Nit = '$Empresa' " ;
	$result003			=mysql_query($query003, $id);
			
	While($row003		=mysql_fetch_array($result003))
	{
	$NombrefullE		=$row003["Nombre"];
	}
	
	
	$query004			="SELECT* FROM Agencias where Cod = '$Agencia' " ;
	$result004			=mysql_query($query004, $id);
			
	While($row004		=mysql_fetch_array($result004))
	{
	$NombrefullA		=$row004["Nombre"];
	}
...
<div class="container">
    ...
    <div class="tab_container">
      <div id="tab1" class="tab_content">
        <form name="form1" method="post" action="act-manifiesto-3.php" onSubmit = "return validar(this)">
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td height="251" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="15%" height="25" bgcolor="#F2F9FD"><span class="Estilo93 Estilo96">&nbsp;</span><span class="Estilo93">NRO MANIFIESTO:                  
                    <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                  </span></td>
                  <td width="35%" bgcolor="#F2F9FD">
                    <input name="Nro" type="text" class="TextField2" id="Nro" style="width:85%" onKeyPress="return isNumberKey(event);" value="<?=$Manifiesto?>" >
                  ...
                  <td width="35%" bgcolor="#F2F9FD">
                    ...
                    <option value="<?=$Agencia?>" selected><?=$NombrefullA?></option>
<?
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="15%" height="25" bgcolor="#F2F9FD"><span class="Estilo93 Estilo96">&nbsp;</span><span class="Estilo93 Estilo96">&nbsp;</span><span class="Estilo93">CONDUCTOR: :
                        <input name="Cedula" type="hidden" id="Cedula" value="<?=$Conductor?>">
                    </span></td>
                    <td width="35%" bgcolor="#F2F9FD"><input name="Conductor" type="text" class="TextField2" id="Conductor" style="width:85%" onKeyUp="form1.Nombre.value=form1.Nombre.value.toUpperCase();" value="<?=$NombrefullC?>" readonly>
                    ...
                    <td width="35%" bgcolor="#F2F9FD"><input name="Placa" type="text" class="TextField2" id="Placa" style="width:95%" onKeyUp="form1.Nombre.value=form1.Nombre.value.toUpperCase();" value="<?=$Placa?>" readonly></td>
                  </tr>
                </table>
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="15%" height="25" bgcolor="#F2F9FD"><span class="Estilo93 Estilo96">&nbsp;</span><span class="Estilo93 Estilo96">&nbsp;</span><span class="Estilo93">ORIGEN: 
                        <input name="Codorg" type="hidden" id="Codorg" value="<?=$Origen?>">
                    </span></td>
                    <td width="35%" bgcolor="#F2F9FD"><input name="Origen" type="text" class="TextField2" id="Origen" style="width:85%" onKeyUp="form1.Nombre.value=form1.Nombre.value.toUpperCase();" value="<?=$Nombreorg?>" readonly>
                    ...
                    <td width="15%" bgcolor="#F2F9FD"><span class="Estilo93 Estilo96">&nbsp;</span><span class="Estilo93">DESTINO: 
                      <input name="Coddest" type="hidden" id="Coddest" value="<?=$Destino?>">
                    </span></td>
                    <td width="35%" bgcolor="#F2F9FD"><input name="Destino" type="text" class="TextField2" id="Destino" style="width:85%" onKeyUp="form1.Nombre.value=form1.Nombre.value.toUpperCase();" value="<?=$Nomdest?>" readonly>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="15%" height="25" bgcolor="#F2F9FD"><span class="Estilo93 Estilo96">&nbsp; </span><span class="Estilo93"> GENERADOR:
                        <input name="Nit" type="hidden" id="Nit" value="<?=$Empresa?>">
                    </span></td>
                    <td width="35%" bgcolor="#F2F9FD"><input name="Empresa" type="text" class="TextField2" id="Empresa" style="width:85%" onKeyUp="form1.Nombre.value=form1.Nombre.value.toUpperCase();" value="<?=$NombrefullE?>" readonly>
                    ...
                    <td width="15%" bgcolor="#F2F9FD"><span class="Estilo93 Estilo96">&nbsp;</span><span class="Estilo93">PROPIETARIO: 
                      <input name="Cedprop" type="hidden" id="Cedprop" value="<?=$Propietario?>">
                    </span></td>
                    <td width="35%" bgcolor="#F2F9FD"><input name="Propietario" type="text" class="TextField2" id="Propietario" style="width:85%" onKeyUp="form1.Nombre.value=form1.Nombre.value.toUpperCase();" value="<?=$NombrefullP?>" readonly>

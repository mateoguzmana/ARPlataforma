...
function retornavalores(registro, nombre){ 
   window.opener.document.form1.Empresa.value=registro;
...
<body>
<form name="form1" method="GET" action="lista-empresas-man.php">
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FBFBFB" onClick="retornavalores('<?=$Nombre8?>', '<?=$Cedula8?>')">

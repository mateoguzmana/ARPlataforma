...
<title>CARROCERIAS DE VEHICULOS</title>
<style type="text/css">
<!--
.titles {
...
function retornavalores(registro, nombre){ 
   window.opener.document.form1.Idcarroceria.value=registro; 
   window.opener.document.form1.Carroceria.value=nombre; 
   window.close(); 
} 
</script>
...
<body>
<form name="form1" method="get" action="lista-carrocerias.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="100" align="right" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="45%" height="35" bgcolor="#003366" class="listado2">&nbsp;<span class="listado1">&nbsp; </span>NOMBRE <br>
              <span class="listado3">
              &nbsp;
	...
	if ($Marca1 <> '')
	{
	$paging->agregarConsulta("SELECT* FROM Tipoauto where Nombre Like '%$Marca1%' order by Nombre Asc"); 
	}
	else
	{
	$paging->agregarConsulta("SELECT* FROM Tipoauto order by Nombre Asc"); 
	}

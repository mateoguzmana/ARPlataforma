								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Ingresar banco nuevo</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-unidades-2.php" novalidate>
                                                        <?
														}
														else
														{
															...
															<div class="form-group">
                                                              <div class="col-lg-1 col-md-2 col-sm-3">
                                                                ...
                                                                <div class="col-lg-11 col-md-10 col-sm-9">
																	<input type="text" name="Nombre" id="Nombre" class="form-control" placeholder="Ingrese un Nombre" onChange="javascript:this.value=this.value.toUpperCase();" required data-rule-minlength="3">
																</div>
															</div>

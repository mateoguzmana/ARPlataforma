...
<body>
<form name="form1" method="GET" action="act-guia.php">
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="100" align="right" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><span class="Estilo93">Nro. Guia</span><span class="listado2"><br>
            <input name="Nit" type="text" class="TextField" id="Nit" style="width:50%">
...
if ($Nit <> '')
{
$paging->agregarConsulta("SELECT* FROM Controlbox where Guia = '$Nit' and Manual = 1 order by Id Desc");
}
else
{
$paging->agregarConsulta("SELECT* FROM Controlbox Where Manual = 1 order by Id Desc");
}
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="20%" bgcolor="#FFFFFF" class="listado"><?=$Guia?></td>
            <td width="55%" bgcolor="#FFFFFF" class="listado"><?=$Empresa?></td>
            <td width="15%" bgcolor="#FFFFFF" class="textos">
             <a href="borrar-guia.php?Id=<?=$Id8?>" onclick=' return confirmSubmit()'> <img src="Images/delete.png" width="12" height="12" border="0"></a>
            </td>
          </tr>
        </table>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">

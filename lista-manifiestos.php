...
{ 
   ...
   window.opener.document.form1.Manifiesto.value=registro; 
...
<body>
<form name="forma" method="get" action="lista-manifiestos.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="100" align="right" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="45%" height="35" bgcolor="#003366" class="listado2">&nbsp;<span class="listado1">&nbsp; </span>NRO MANIFIESTO  <br>
              <span class="listado3">
              &nbsp;
	...
	if ($Marca1 <> '')
	{
	$paging->agregarConsulta("SELECT* FROM Manifiestos where Nromanifiesto = '$Marca1' and Estado = 0 order by Fecha Desc"); 
	}
	else
	{
	$paging->agregarConsulta("SELECT* FROM Manifiestos where Estado = 0  order by Fecha Desc"); 
	}
...
{	
$Nromanifiesto			=strtoupper($row008["Nromanifiesto"]);
$Idru					=$row008["Id"];
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0"  onClick="retornavalores('<?=$Nromanifiesto?>')">
         
            <tr name="datos1" id="datos1" onMouseover="this.bgColor='#BED9F3'"onMouseout="this.bgColor='#FBFBFB'" >
              <td height="15"><span class="Estilo93"><?=strtoupper($Nromanifiesto)?></span></td>
            </tr>

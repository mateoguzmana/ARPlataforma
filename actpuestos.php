...
?>
                  <option value="actpuestos.php?Iddep=<?=$Id9?>" selected>
                    <?=$Nombre9?>
                    </option>
                  <?
}
...
$Id8			=$row008["Id"];
?>
                  <option value="actpuestos.php?Iddep=<?=$Id8?>">
                    <?=$Nombre8?>
                    </option>
                  <?
}
...
?>
      ...
      <?
$query008="SELECT* FROM Puestos where Iddep = '$Iddep' order by Nombre" ;
$result008=mysql_query($query008, $id);
...
<td width="206" bgcolor="#FFFFFF" class="textos"><a href="actpuesto2.php?Id=<?=$Id8?>">Act</a> | <a onclick=' return confirmSubmit()' href="elpuesto.php?Id=<?=$Id8?>">Elim</a>&nbsp;</td>
        </tr>
    </table>
<?
}

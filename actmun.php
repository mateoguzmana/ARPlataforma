  ...
  <tr>
    <td height="100" align="right" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="61" align="right" bgcolor="#F7F7F7"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
...
?>
                  <option value="actmun.php?Iddep=<?=$Id9?>" selected>
                    <?=$Nombre9?>
                    </option>
                  <?
}
...
$Id8			=$row008["Id"];
?>
                  <option value="actmun.php?Iddep=<?=$Id8?>">
                    <?=$Nombre8?>
                    </option>
                  <?
}
...
?>
                ...
                <input name="Iddep" type="hidden" id="Iddep" value="<?=$Iddep?>"></td>
            </tr>
          </table></td>
        </tr>
      </table>
      <?
$query007="SELECT* FROM Municipio where Iddep = '$Iddep' order by Nombre" ;
...
?>
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="952" bgcolor="#FFFFFF" class="listado"><?=$Nombre7?></td>
<td width="206" bgcolor="#FFFFFF" class="textos"><a href="actmun2.php?Id=<?=$Id7?>">Act</a> | <a onclick=' return confirmSubmit()' href="elimun.php?Id=<?=$Id7?>">Elim</a>&nbsp;</td>
        </tr>
    </table>
<?
}

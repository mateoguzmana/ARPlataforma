...
<title>COLROES DE VEHICULOS</title>
<style type="text/css">
<!--
.titles {
...
<script> 
function retornavalores(Comercial, Cedcomer)
{ 
   window.opener.document.form1.Despachos.value=Comercial; 
   window.opener.document.form1.Ceddespa.value=Cedcomer; 
   window.close(); 
} 
</script>
...
<body>
<form name="form1" method="get" action="lista-despachos.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	if ($Marca1 <> '')
	{
	$paging->agregarConsulta("SELECT* FROM Usuarios where Nombrefull Like '%$Marca1%' and Tipo = 0  order by Nombrefull Asc"); 
	}
	else
	{
	$paging->agregarConsulta("SELECT* FROM Usuarios where Tipo = 0  order by Nombrefull Asc"); 
	}
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="retornavalores('<?=$Nombre ?>', '<?=$Cedula?>')">
          <a href="#" onClick="retornavalores('<?=$Nombre ?>', '<?=$Cedula?>')">

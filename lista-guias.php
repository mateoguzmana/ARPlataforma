...
$Fechahoy= date("Y-m-d");	
	...
	$paging->agregarConsulta("SELECT* FROM Controlbox where Cataporte > '0' ".$consultar." Group by Cataporte Order by Cataporte Desc"); 
...
?>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" onMouseover="this.bgColor='#BED9F3'"onMouseout="this.bgColor='#FFFFFF'">
          <tr>
            ...
            <td width="10%" align="right" class="listado"><a href="listaguias.php?Cataporte=<?=$Cataporte?>&Empresa=<?=$Empresa?>" target="_blank"><img src="Images/imprimir.jpg" width="19" height="20" borde = "0"></a></td>
          </tr>
        </table>

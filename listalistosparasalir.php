...
{ 
var agree=confirm("Desea salir a asignacion de transito? "); 
if (agree) 
return true ; 
else 
return false ; 
...
</span><span class="lista">NO SE ENCONTRARON RESULTADOS EN SU BUSQUEDA - <a href="listalistosparasalir.php" style="color: #00F">VOLVER</a></span><span class="Estilo101"><br>
<br>
</span>
<?
}
...
{	
		...
		$query		="SELECT COUNT(*) AS TOTAL FROM Asignacioncata WHERE Manifiesto = '$Nombrer'" ;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F8F8F8" onMouseover="this.bgColor='#E2F5C9'"onMouseout="this.bgColor='#F8F8F8'">
        <tr>
          <td width="1%" height="15" align="center" class="titles">&nbsp;</td>
          <td width="49%" class="lista" style="font-size: 9px"><span class="lista" style="font-size: 9px">
            <?=$Nombrer?>
          </span></td>
          <td width="40%" class="lista" style="font-size: 9px"><span class="lista" style="font-size: 9px">
            (<?=$TOTAL?>) Cataportes
          </span></td>
          <td width="10%" align="center" class="titles"><a onClick='return confirmSubmit();' href="salir-a-asignacion.php?Man=<?=$Nombrer?>"><img src="Images/add.png" alt="MODIFICAR" title="MODIFICAR" width="15" height="15" border="0"></a></td>
          </tr>
      </table>

...
function retornavalores(registro, nombre){ 
   window.opener.document.form1.Configuracion.value=registro; 
   window.opener.document.form1.Configuracion.value=nombre; 
   window.close(); 
} 
</script>
...
<form name="form1" method="get" action="lista-lineas.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	$paging->agregarConsulta("SELECT* FROM Configcar order by Nombre Asc"); 

...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="100" align="center" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <?
$query008="SELECT* FROM Cargos order by Nombre" ;
...
<td align="center" valign="middle" bgcolor="#FFFFFF" class="textos"><a href="actcargoempresa2.php?Id=<?=$Id?>"><img src="Images/update-ico-2.jpg" width="16" height="15" border="0"></a> | <a onclick=' return confirmSubmit()' href="elicargoempresa.php?Id=<?=$Id?>"><img src="Images/delete-icon-2.jpg" width="16" height="15" border="0"></a></td>

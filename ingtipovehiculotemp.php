...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="60" align="center" valign="top"><form name="form1" method="post" action="ingtipovehiculotemp2.php">
...
?>
        <BR>
        <BR>
        <span class="TextFieldFU">&nbsp;&nbsp;EL TIPO DE VEHICULO SE INGRESO CON EXITO&nbsp;&nbsp;</span> <BR>
        <BR>
        <?
}
?>
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">Tipo de Vehiculo</div>

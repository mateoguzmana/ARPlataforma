...
function retornavalores(registro, Codorg){ 
   window.opener.document.form1.Origen.value=registro;
   window.opener.document.form1.Codorg.value=Codorg;
...
<body>
<form name="forma" method="get" action="lista-ciudades-origen.php">

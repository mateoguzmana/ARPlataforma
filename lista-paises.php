...
function retornavalores(registro, nombre){ 
   window.opener.document.form1.Paistrailer.value=registro; 
   window.opener.document.form1.Paistrailer.value=nombre; 
...
<body>
<form name="forma" method="get" action="lista-paises.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="100" align="right" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="45%" height="35" bgcolor="#003366" class="listado2">&nbsp;<span class="listado1">&nbsp; </span>NOMBRE PAIS<br>
              <span class="listado3">
              &nbsp;
	...
	if ($Marca1 <> '')
	{
	$paging->agregarConsulta("SELECT* FROM Paises where PAI_NOMBRE Like '%$Marca1%' order by PAI_NOMBRE Asc"); 
	}
	else
	{
	$paging->agregarConsulta("SELECT* FROM Paises order by PAI_NOMBRE Asc"); 
	}
...
{	
$Nombre			=strtoupper($row008["PAI_NOMBRE"]);
$Idmarca		=$row008["1"];
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0"  onClick="retornavalores('<?=$Nombre ?>', '<?=$Nombre?>')">

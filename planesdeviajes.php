...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="top" bgcolor="#F7F7F7"><table width="100%" border="0" bordercolor="#FFFFFF" cellpadding="0" cellspacing="0" background="Images/bg-seleccion.jpg">
      <tr>
        <td width="1%" height="20" class="itemselect1">&nbsp;</td>
        <td width="100%" align="left" class="itemselect1"><span class="itemselect">PLANES DE VIAJE</span></td>
      </tr>

    </table>
<iframe src="planesviaje.php" id="maestro" name="maestro" scrolling="no" width="100%" height="100%" frameborder="No" allowtransparency="true"></iframe></td>
  </tr>
</table>
</body>

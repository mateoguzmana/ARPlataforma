...
<script> 
function retornavalores(cedula)
{ 
...
<body>
<form name="form1" method="get" action="lista-conductores-ing.php">
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	elseif ($Cedula1 <> '')
	{
	$paging->agregarConsulta("SELECT* FROM Conductores where Nit = '$Cedula1' order by Apellido1 Asc"); 
	}
	else
	{
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="retornavalores('<?=$Cedula ?>')">

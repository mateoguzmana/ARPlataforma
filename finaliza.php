...
<table width="480" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr onMouseover="this.bgColor='#BED9F3'"onMouseout="this.bgColor='#FFFFFF'" >
    <td height="455" align="center" valign="top" bgcolor="#E0E9F1"><table width="450" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" align="left" valign="middle" bgcolor="#E9E9E9" class="Estilo971">&nbsp;INFORMACION REMESA <span style="color: #900">(
          <?=$Remesa?>
          )</span></td>
      </tr>
    </table>
    ...
    <table width="450" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <form id="freporte" name="freporte" method="post" action="finalizar.php" onSubmit = "return validar(this);">
            ...
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="130" height="20" valign="middle" bgcolor="#E0E9F1" class="Estilo931">REMESA NRO.</td>
                <td width="300" align="left" valign="middle" bgcolor="#E0E9F1" class="Estilo931"><span class="Estilo1051">
                  <?=$Remesa?>
                </span></td>
              </tr>
          </table>
...
?>
            ...
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="13" bgcolor="#003366" class="Estilo93">&nbsp;</td>
                <td width="417" bgcolor="#003366" class="Estilo93" style="color: #FFF; font-size: 14px;">EVALUAR CONDUCTOR </td>
              </tr>
            </table>
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="41" height="18" align="center" valign="middle" class="Estilo93">SI</td>
                <td width="42" align="center" class="Estilo93">NO</td>
                <td width="347" align="center" class="Estilo93">&nbsp;</td>
              </tr>
            </table>
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="41" height="32" align="center" bgcolor="#FFFFFF" class="Estilo93"><p>
                  <input type="radio" name="Cal1" id="radio" value="1">
                </p></td>
                <td width="42" align="center" bgcolor="#FFFFFF" class="Estilo93"><input type="radio" name="Cal1" id="radio2" value="2"></td>
                <td width="347" align="left" bgcolor="#FFFFFF" class="listado3" style="color: #000; font-size: 10px;">El conductor se reportó en todos los puestos de control de la ruta.</td>
              </tr>
            </table>
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="42" align="center" bgcolor="#FFFFFF" class="Estilo93"><input type="radio" name="Cal2" id="radio4" value="2"></td>
            ...
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="42" align="center" bgcolor="#FFFFFF" class="Estilo93"><input type="radio" name="Cal3" id="radio6" value="2"></td>
            ...
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="42" align="center" bgcolor="#FFFFFF" class="Estilo93"><input type="radio" name="Cal4" id="radio8" value="2"></td>
            ...
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="41" height="32" align="center" bgcolor="#FFFFFF" class="Estilo93"><p>
                  <input type="radio" name="Cal5" id="radio9" value="1">
                </p></td>
                <td width="42" align="center" bgcolor="#FFFFFF" class="Estilo93"><input type="radio" name="Cal5" id="radio10" value="2"></td>
                <td width="347" align="left" bgcolor="#FFFFFF" class="listado3" style="color: #000; font-size: 10px;">El vehiculo presento accidentes o problemas mecanicos durante el recorrido con la mercancia</td>
              </tr>
            </table>
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="41" height="18" align="center" valign="middle" class="Estilo93">&nbsp;</td>
                <td width="42" align="center" class="Estilo93">&nbsp;</td>
                <td width="347" align="center" class="Estilo93">&nbsp;</td>
              </tr>
            </table>
            <table width="430" border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="Estilo93"><table width="430" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="32" align="center" class="Estilo93"><p>Si presiona FINALIZAR REMESA el viaje saldrá de <span class="Estilo105">"EN TRANSITO"</span>,   Todos los reportes realizados se podrán encontrar en el Histórico.<span class="Estilo105">
...
//-->
            ...
            <table width="430" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="134" height="23" class="Estilo931"><label>
                <?
                if($Contenedorcont == 1 && $Entregacont == 0)
				{
				?>
<input name="btsubmit1" OnClick="alert('Este viaje tiene contenedor por entregar'); return validas(this);" type="submit" class="TextField3" id="btsubmit1" value="FINALIZAR REMESA">
                <?
				}
				else
				{
...
<input name="btsubmit1" type="submit" class="TextField3" id="btsubmit1" value="FINALIZAR REMESA" onClick="return validas(this);">
                ...
                <td width="136" class="Estilo931"><input name="salir" type="button" class="TextField31" id="salir" value="SALIR" onClick="window.close();"></td>
                <td width="160" class="Estilo931">&nbsp;</td>
              </tr>
            </table>
          </form></td>
        </tr>

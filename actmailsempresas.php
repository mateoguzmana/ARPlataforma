...
<body>
<form name="form1" method="GET" action="actmailsempresas.php">
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="100" align="right" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="6%"><span class="Estilo93">Empresa</span><span class="listado2"><br>
...
?>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="20%" bgcolor="#FFFFFF" class="listado"><?=$Cedula8?></td>
            <td width="55%" bgcolor="#FFFFFF" class="listado"><?=$Nombre8?></td>
            <td width="15%" bgcolor="#FFFFFF" class="textos"><a href="actmailsempresas2.php?Id=<?=$Id8?>"><img src="Images/update-ico-2.jpg" width="16" height="15" border="0"></a></td>
          </tr>
        </table>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>

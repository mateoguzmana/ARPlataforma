...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="top" bgcolor="#F7F7F7"><table width="100%" border="0" bordercolor="#FFFFFF" cellpadding="0" cellspacing="0" background="Images/bg-seleccion.jpg">
      <tr>
        <td width="99%" height="20" align="right" class="itemselect1">CATAPORTES GENERADOS </td>
        <td width="1%" align="center" class="itemselect1"></td>
      </tr>
      <tr>
        <td height="5" colspan="2" align="center" class="itemselect1"><form name="form1" method="Get" action="listacataportes.php" target="sellos" style="margin:0">
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="15%" valign="bottom" bgcolor="#003366" class="listado1"><span class="listado2">NRO. CATAPORTE
                <br>
    ...
    <iframe src="listacataportes.php" id="sellos" name="sellos" width="100%" height="90%" frameborder="No" allowtransparency="true"></iframe></td>
  </tr>
</table>
</body>
